...
class Locator:
    ...
    async def tap(self, **options: object) -> None: ...
    async def evaluate(self, expression: str, **options: object) -> object: ...
    async def get_attribute(self, name: str) -> Optional[str]: ...
...
class Page:
    ...
    async def wait_for_function(
        ...
        polling: Union[float, str] = "raf",
    ) -> JsonValue: ...
    async def wait_for_url(
        self, url: Union[str, object], **options: object
    ) -> None: ...
    ...
    @overload
    def locator(self, selector: str, has_text: str) -> Locator: ...
