...
from typing import (
    TypeVar, Callable, Union, Generator, Iterator, Optional, Dict, List, Any, 
...
def approx(expected: Union[float, int], rel: Optional[float] = None, abs: Optional[float] = None) -> float: ...
...
# Export key items
__all__ = [
    'fixture', 'mark', 'raises', 'approx', 'fail', 'skip', 
    'MonkeyPatch', 'MarkDecorator'
]