...
from backend.api.models import (
    ...
    AnalysisResult, WebSocketMessage, MatchmakingRequest, PlayerStats
)
...
class TestMove:
    ...
    def test_move_with_evaluation(self):
...
class TestGameResponse:
    ...
    def test_from_game_session(self):
...
class TestMoveResponse:
    ...
    def test_move_response_with_winner(self):
...
class TestMatchmakingRequest:
    ...
    def test_matchmaking_request(self):
