    ...
    async def test_multiple_tabs_same_app(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await expect(page1.locator('[data-testid="game-container"]')).to_be_visible(timeout=10000)
                ...
                await expect(page2.locator('[data-testid="game-container"]')).to_be_visible(timeout=10000)
                ...
                await expect(page1.locator('[data-testid="game-setup"]')).to_be_visible(timeout=5000)
                await expect(connection_text_1).to_have_text("Connected")
                
                # Tab 2 should be unaffected
                expect(page2.locator('[data-testid="game-container"]')).to_be_visible()
    ...
    async def test_tab_switching_and_return(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await expect(app_page.locator('[data-testid="game-container"]')).to_be_visible(timeout=10000)
                ...
                expect(app_page.locator('[data-testid="game-container"]')).to_be_visible()
                
                # New Game should work
                new_game_button = app_page.locator('button:has-text("New Game")')
                await new_game_button.click()
                
                await expect(app_page.locator('[data-testid="game-setup"]')).to_be_visible(timeout=5000)
    ...
    async def test_window_focus_and_blur_events(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await expect(page.locator('[data-testid="game-container"]')).to_be_visible(timeout=10000)
                ...
                await expect(connection_text).to_have_text("Connected", timeout=5000)
                expect(page.locator('[data-testid="game-container"]')).to_be_visible()
                
                # New Game should work after focus events
                new_game_button = page.locator('button:has-text("New Game")')
                await new_game_button.click()
                
                await expect(page.locator('[data-testid="game-setup"]')).to_be_visible(timeout=5000)
                await expect(connection_text).to_have_text("Connected")
    ...
    async def test_concurrent_browser_instances(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                new_game_button = first_browser_page.locator('button:has-text("New Game")')
                await new_game_button.click()
                
                await expect(first_browser_page.locator('[data-testid="game-setup"]')).to_be_visible(timeout=5000)
                
                first_connection = first_browser_page.locator('[data-testid="connection-text"]')
