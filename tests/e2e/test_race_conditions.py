            ...
            try:
                ...
                for i in range(5):
                    ...
                    if await start_button.count() > 0:
                        click_tasks.append(asyncio.create_task(
    ...
    async def test_settings_changes_during_game_creation(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await page.route("**/games", async lambda route: (
    ...
    async def test_concurrent_new_game_clicks_from_different_contexts(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                concurrent_clicks = [
                    asyncio.create_task(new_game_button.click(timeout=2000))
                    for _ in range(3)
                ]
                ...
                successful_clicks = sum(1 for r in click_results if not isinstance(r, Exception))
    ...
    async def test_rapid_connection_state_changes_during_reset(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                connection_tasks = [
                    asyncio.create_task(page.evaluate("() => window.dispatchEvent(new Event('offline'))")),
                    asyncio.create_task(asyncio.sleep(0.1)),
                    asyncio.create_task(page.evaluate("() => window.dispatchEvent(new Event('online'))")),
                    asyncio.create_task(asyncio.sleep(0.1)),
                    asyncio.create_task(page.evaluate("() => window.dispatchEvent(new Event('offline'))")),
                    asyncio.create_task(asyncio.sleep(0.1)),
                    asyncio.create_task(page.evaluate("() => window.dispatchEvent(new Event('online'))")),
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                changes = [
                    ...
                    ("mode-human-vs-human", page.locator('[data-testid="mode-human-vs-human"]')),
