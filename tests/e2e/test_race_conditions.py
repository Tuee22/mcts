...
class TestRaceConditions:
    ...
    # NOTE: Two tests were removed due to flakiness:
    # - test_page_navigation_during_reset: timing issues between navigation and state reset
    # - test_rapid_connection_state_changes_during_reset: rapid timing conflicts
