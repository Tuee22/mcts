...
class TestRaceConditions:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await asyncio.gather(
                    new_game_task, settings_task, return_exceptions=True
                )
    ...
    async def test_multiple_start_game_clicks_rapid_succession(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                print(
                    f"✅ {successful_clicks} out of {len(click_tasks)} clicks succeeded"
                )
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                click_results = await asyncio.gather(
                    *concurrent_clicks, return_exceptions=True
                )
    ...
    async def test_page_navigation_during_reset(self, e2e_urls: Dict[str, str]) -> None:
        """
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await asyncio.gather(
                    new_game_task, refresh_task, return_exceptions=True
                )
