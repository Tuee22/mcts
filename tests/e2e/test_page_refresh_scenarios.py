    ...
    async def test_refresh_with_console_errors(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                critical_errors = [err for err in console_errors if 'WebSocket' in err.text or 'connection' in err.text.lower()]
                ...
                print(f"ℹ️ Total console errors: {final_errors} (started with {initial_errors})")
