...
class TestPageRefreshScenarios:
    ...
    async def test_new_game_then_refresh_connection_bug(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                print(
                    f"✅ Connection status after New Game: {connection_status_before_refresh}"
                )
    ...
    async def test_refresh_during_game_creation(self, e2e_urls: Dict[str, str]) -> None:
        """
    ...
    async def test_refresh_with_console_errors(self, e2e_urls: Dict[str, str]) -> None:
        """
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if critical_errors:
                    print(
                        f"⚠️ Found {len(critical_errors)} connection-related console errors"
                    )
