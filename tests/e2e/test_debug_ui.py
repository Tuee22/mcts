...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_debug_game_start(page: Page, e2e_urls: Dict[str, str]) -> None:
    ...
    await handle_settings_interaction(page, should_click_start_game=False)
    ...
    await page.screenshot(path="/tmp/before_start.png")
    ...
    error_elements = page.locator(".error, .toast, .warning")
